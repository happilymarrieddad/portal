...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            {{ Form::open(array('route'=>'article.update')) }}
            <table class="table table-bordered">
                ...
                <tr class="form-group">
                    ...
                    <td><input class="form-control" id="name" type="text" name="name" value="{{ $article->name }}" required /></td>
                </tr>
                <tr class="form-group">
                    <td><label for="article">Article</label></td>
                    <td><textarea class="form-control" id="article" name="article" rows="10"  value="{{ $article->article }}" required="required"></textarea></td>
                </tr>
                <tr class="form-group">
